...
public class CameraController : MonoBehaviour
{
    ...
    private CinemachineCameraController camCamera;
    ...
    void Awake()
    {
        ...
        camCamera = FindAnyObjectByType<CinemachineCameraController>();
    }
    ...
    public void MoveToStage(Vector3 stageCenter, int zoomedInSize)
    {
        ...
        camCamera.MoveToStage(stageCenter, zoomedInSize);
    }
    ...
    public void MoveToWorld(Vector3 worldViewCenter, int zoomedOutSize)
    {
        ...
        camCamera.MoveToWorld(worldViewCenter, zoomedOutSize);
    }
}